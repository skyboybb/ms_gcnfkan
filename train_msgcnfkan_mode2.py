...
import logging
from utils.train_MMMGCN_method2_utils import train_utils
args = None

def parse_args():
    parser = argparse.ArgumentParser(description='Train')
    # basic parameters
    parser.add_argument('--model_name', type=str, default='MMMChebyNetKAN_method2', help='the name of the model')
    parser.add_argument('--sample_length', type=int, default=1024, help='batchsize of the training process')
    parser.add_argument('--data_name', type=str, default='MotorPathMSFFT_sets', help='the name of the data')#XJTUGearboxKnn
    #parser.add_argument('--data_name', type=str, default='MotorPath_a', help='the name of the data')  # XJTUGearboxKnn

    parser.add_argument('--Input_type', choices=['MMMMSFFT'],type=str, default='MMMMSFFT', help='the input type decides the length of input')

    parser.add_argument('--data_dir', type=str, default= "./data/Motor", help='the directory of the data')#./data/XJTUGearbox/XJTUGearboxKnn.pkl
