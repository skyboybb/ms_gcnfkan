...
class train_utils_wpd(object):
    ...
    def train(self):
        ...
        def compute_accuracy(model,feature_1,feature_2,feature_3,feature_4,feature_5,feature_6,feature_7,
                             feature_8,labels):
            ...
            for i in range(total_batch):
                ...
                features_4 = feature_4[rand_index, :]
                features_5 = feature_5[rand_index, :]
                features_6 = feature_6[rand_index, :]
                features_7 = feature_7[rand_index, :]
                features_8 = feature_8[rand_index, :]
                targets = labels[rand_index]
                features_1 = features_1.to(device)
                features_2 = features_2.to(device)
                features_3 = features_3.to(device)
                features_4 = features_4.to(device)
                features_5 = features_5.to(device)
                features_6 = features_6.to(device)
                features_7 = features_7.to(device)
                features_8 = features_8.to(device)
                targets = targets.to(device)
                logits, probas = model(features_1,features_2,features_3,features_4,features_5,features_6,features_7,features_8)
        ...
        for epoch in range(num_epochs):
            ...
            for i in range(total_batch):
                ...
                features_4 = self.datasets_4['train'][rand_index, :]
                features_5 = self.datasets_5['train'][rand_index, :]
                features_6 = self.datasets_6['train'][rand_index, :]
                features_7 = self.datasets_7['train'][rand_index, :]
                features_8 = self.datasets_8['train'][rand_index, :]
            ...
            with torch.set_grad_enabled(False):  # save memory during inference
                trl, trac, _ = compute_accuracy(model, self.datasets_1['train'],self.datasets_2['train'],self.datasets_3['train'],self.datasets_4['train'],self.datasets_5['train'],self.datasets_6['train'],self.datasets_7['train'],self.datasets_8['train'], self.label['train'])
                val, vaac, _ = compute_accuracy(model, self.datasets_1['val'],self.datasets_2['val'],self.datasets_3['val'],self.datasets_4['val'],self.datasets_5['val'],self.datasets_6['val'],self.datasets_7['val'],self.datasets_8['val'], self.label['val'])
        ...
        torch.save(self.model, 'trained_model/WPDCNN_3.pth')  # 保存整个网络参数
        # In[]
        # loss曲线
        ...
        model = torch.load('trained_model/WPDCNN_3.pth')
        ...
        inputs_4 = self.datasets_4['val'].to(self.device)
        inputs_5 = self.datasets_5['val'].to(self.device)
        inputs_6 = self.datasets_6['val'].to(self.device)
        inputs_7 = self.datasets_7['val'].to(self.device)
        inputs_8 = self.datasets_8['val'].to(self.device)
        model.to(self.device)
        model.eval()
        logits, probas = model(inputs_1, inputs_2, inputs_3, inputs_4, inputs_5, inputs_6, inputs_7, inputs_8)
