...
def data_load(signal_size, filename, axisname, label, InputType, task):
    ...
    graphset_1 = PathGraph(11, data_1, label, task)
    graphset_2 = PathGraph(11, data_2, label, task)
    graphset_3 = PathGraph(11, data_3, label, task)
