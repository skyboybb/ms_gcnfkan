...
def get_files(sample_length, root, InputType, task, test=False):
    ...
    data_1, data_2, data_3, data_4, data_5, data_6, data_7, data_8,label_0 = data_load_1(sample_length, path1,axisname=normalname[0],InputType=InputType,task=task)  # nThe label for normal data is 0
    for i in tqdm(range(len(dataname9))):
        path2 = os.path.join(data_root2, dataname9[i])
        data1, data2, data3, data4, data5, data6, data7, data8, label_all = data_load(sample_length, path2, dataname9[i],
