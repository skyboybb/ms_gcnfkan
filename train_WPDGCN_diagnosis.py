...
import logging
from utils.train_WPDGCN_utils import train_utils
...
def parse_args():
    ...
    # basic parameters
    parser.add_argument('--model_name', type=str, default='ChebyNet_3', help='the name of the model')
    parser.add_argument('--sample_length', type=int, default=2000, help='batchsize of the training process')
    parser.add_argument('--data_name', type=str, default='PDBONPath_sets', help='the name of the data')#XJTUGearboxKnn
