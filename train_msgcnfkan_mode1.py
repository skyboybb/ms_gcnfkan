...
import logging
from utils.train_MMMGCN_utils import train_utils
args = None

def parse_args():
    parser = argparse.ArgumentParser(description='Train')
    # basic parameters
    parser.add_argument('--model_name', type=str, default='MMMChebyNetKAN', help='the name of the model')
    parser.add_argument('--sample_length', type=int, default=1024, help='batchsize of the training process')
    parser.add_argument('--data_name', type=str, default='GearPathMSFFT_sets', help='the name of the data')#XJTUGearboxKnn
    ...
    parser.add_argument('--data_dir', type=str, default= "./data/Gear", help='the directory of the data')#./data/XJTUGearbox/XJTUGearboxKnn.pkl
