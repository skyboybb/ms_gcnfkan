...
import logging
from utils.train_MSCNN_utils import train_utils_ms
...
def parse_args():
    ...
    # basic parameters
    parser.add_argument('--model_name', type=str, default='MSCNN_3', help='the name of the model')
    parser.add_argument('--sample_length', type=int, default=2000, help='batchsize of the training process')
    parser.add_argument('--data_name', type=str, default='CWRUms_sets', help='the name of the data')


    parser.add_argument('--Input_type', choices=['MS_1','MS_2','MS_3'],type=str, default='MS_3', help='the input type decides the length of input')

    parser.add_argument('--data_dir', type=str, default= "./data/CWRU", help='the directory of the data')
...
if __name__ == '__main__':
    ...
    trainer = train_utils_ms(args, save_dir)
    trainer.setup()
    trainer.train()
