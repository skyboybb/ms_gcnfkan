...
import logging
from utils.train_GCN_utils import train_utils
...
def parse_args():
    ...
    parser.add_argument('--data_name', type=str, default='GearPath_sets', help='the name of the data')#XJTUGearboxKnn
    #parser.add_argument('--data_name', type=str, default='MotorPath_a', help='the name of the data')  # XJTUGearboxKnn

    parser.add_argument('--Input_type', choices=['TD'],type=str, default='TD', help='the input type decides the length of input')
